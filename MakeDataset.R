# Generate transformed data set from input data
...
data_final <- data_final %>% select(hrmax, hrmin, hrstd, hrmedian, hr, edaskew, edastd, hrmean, eda, edarange, Subject, metric)
