...
# [112]	train-rmse:0.332998	test-rmse:0.344116
...
# 216/216 [==============================] - 0s 2ms/step - loss: 0.1606 - val_loss: 0.1609
...
print(mean(results$PRECISION, na.rm=TRUE)) # 0.548
print(mean(results$RECALL, na.rm=TRUE)) # 0.44
print(mean(results$F1, na.rm=TRUE)) # 0.56
